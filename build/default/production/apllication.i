...
# 1 "./ECU_layer/LED/../../MCAL_layer/GPIO/../std_library.h" 1
# 13 "./ECU_layer/LED/../../MCAL_layer/GPIO/../std_library.h"
...
# 13 "./ECU_layer/LED/../../MCAL_layer/GPIO/../std_library.h" 2
...
void application_init(void);
LED_T led1 = {.LED_STATUS = LED_ONN ,.PIN_NUM = PIN0 ,.PORT_NUM =PORTD_INDEX};
LED_T led2 = {.LED_STATUS = LED_ONN ,.PIN_NUM = PIN1 ,.PORT_NUM =PORTD_INDEX};


Button_t Bt1 = {.Button_Activate =Button_Active_High ,.Button_Pin.direction = input
        ,.Button_Pin.logic =high,
          .Button_Pin.pin_num = PIN0
        ,.Button_Pin.port = PORTA_INDEX,
         .Button_State = Button_NotPressed
};
Button_t Bt2 = {.Button_Activate =Button_Active_High ,.Button_Pin.direction = input
        ,.Button_Pin.logic =high,
          .Button_Pin.pin_num = PIN1
        ,.Button_Pin.port = PORTA_INDEX,
         .Button_State = Button_NotPressed
};
int main()
{
    ...
    while(1)
    {
        Button_Read_State(&Bt1,&status1);
        Button_Read_State(&Bt2,&status2);
