...
# 1 "MCAL_layer/GPIO/../std_library.h" 1
# 13 "MCAL_layer/GPIO/../std_library.h"
...
# 13 "MCAL_layer/GPIO/../std_library.h" 2
...
# 14 "MCAL_layer/GPIO/../std_library.h" 2
...
STD_TeturnType gpio_pin_intialize(const Pin_config *_pin_config){
    STD_TeturnType ret = (STD_TeturnType)0x01;
    if(_pin_config == ((void*)0))
    {
        ret =(STD_TeturnType)0x00;
    }
    else
    {
...
{
    STD_TeturnType ret = (STD_TeturnType)0x01;
    if(_PIN_ == ((void*)0) || _PIN_ ->pin_num > 8 -1)
    {
        ret = (STD_TeturnType)0x00;
    }
    else
    ...
    {
        case Output:
            *TRIS_register[_PIN_->port] &= ~(1<<_PIN_->pin_num);
        break;
        case input:
             *TRIS_register[_PIN_->port] |= (1<<_PIN_->pin_num);
        break;
...
{
        STD_TeturnType ret = (STD_TeturnType)0x01;
        if(_PIN_ == ((void*)0) ||dic_status == ((void*)0))
        {
            ret = (STD_TeturnType)0x00;
        }
        else
        {
            *dic_status = ((*TRIS_register[_PIN_->port]>>_PIN_->pin_num) & 1);
        }
        return ret;
}
...
STD_TeturnType gpio_pin_write_logic(const Pin_config *_PIN_,Logic_t logic)
{
       STD_TeturnType ret = (STD_TeturnType)0x01;
        ...
        else
        {
            ...
            {
                case high:
                    *LAT_register[_PIN_->port] |= (1<<_PIN_->pin_num);
                    break;
                case low:
                    *LAT_register[_PIN_->port] &= ~(1<<_PIN_->pin_num);
                    break;
...
{
       STD_TeturnType ret = (STD_TeturnType)0x01;
        if(_PIN_ == ((void*)0) ||logic == ((void*)0))
        {
            ret = (STD_TeturnType)0x00;
        }
        else
        {
         *logic = ((*PORT_register[_PIN_->port]>>_PIN_->pin_num) & 1);
        }
        return ret;
}
...
{
       STD_TeturnType ret = (STD_TeturnType)0x01;
       if(_Port_ >5 -1 || direction_status == ((void*)0))
       {
           ret = (STD_TeturnType)0x00;
       }
       else
