...
# 1 "ECU_layer/Button/../../MCAL_layer/GPIO/../std_library.h" 1
# 13 "ECU_layer/Button/../../MCAL_layer/GPIO/../std_library.h"
...
# 13 "ECU_layer/Button/../../MCAL_layer/GPIO/../std_library.h" 2
...
STD_TeturnType Button_INIT(const Button_t*Button)
{
    uint8 Return_State = (STD_TeturnType)0x01;
    if(Button == ((void*)0))
    {
        Return_State = (STD_TeturnType)0x00;
    }
    else
    {
...
STD_TeturnType Button_Read_State(const Button_t*Button, Button_State *BtnState)
{
    uint8 Return_State = (STD_TeturnType)0x01;
    Logic_t Status = low;
    if(Button == ((void*)0) || BtnState == ((void*)0))
    {
        Return_State = (STD_TeturnType)0x00;
    }
    else
    {
        ...
        Return_State =(STD_TeturnType)0x01;
    }
return Return_State;
}
